// Created by Preetish Vij on 10 july,18
...
var locations = [
    {title: 'Akshardham', location: {lat: 28.6127, lng: 77.2773}, index:0},
    {title: 'Worlds of Wonder', location: {lat: 28.5638, lng: 77.3261},index:1},
    {title: 'India Gate', location: {lat: 28.6129, lng: 77.2295}, index:2},
    {title: 'Red Fort', location: {lat: 28.6562, lng: 77.2410}, index:3},
    {title: 'Qutb Minar', location: {lat: 28.5244, lng: 77.1855}, index:4},
    {title: 'Lotus Temple', location: {lat: 28.5535, lng: 77.2588}, index:5}
];
